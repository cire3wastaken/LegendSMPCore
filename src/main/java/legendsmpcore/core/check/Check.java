...
public class Check {
    ...
    public String format = ChatColor.BOLD.toString() + ChatColor.GOLD + "LegendSMP" + ChatColor.RESET +
            ChatColor.DARK_GRAY +" >> " + ChatColor.RESET + "%s failed " + ChatColor.YELLOW +
            "%s" + ChatColor.RESET + " (Check %s)" + ChatColor.RED + " (Severity %s) " + ChatColor.DARK_RED + "[1/1]";
