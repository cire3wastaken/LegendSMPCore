...
public final class Permissions {
    ...
    public static final String ITEM_MANAGE_PERM = "legendsmp.customitems.manageplugin";
    public static final String ITEM_UPDATE_PERM = "legendsmp.customitems.updateitems";
    public static final String ITEM_REGIONS_PERM = "legendsmp.customitems.regions";
    public static final String ITEM_PLAYERS_PERM = "legendsmp.customitems.manageplayers";
